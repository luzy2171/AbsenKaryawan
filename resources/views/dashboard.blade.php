...
<head>
    ...
    <style>
        ...
        @keyframes highlightFade {
            0% { background-color: #e8f5e9; transform: scale(1.01); }
                ...
                <div class="col-md-3">
                    <div class="card card-custom stat-card p-3 bg-white">
                        <div class="d-flex justify-content-between align-items-start">
                            ...
                            <div class="stat-icon bg-warning-subtle text-warning"><i class="bi bi-exclamation-circle"></i></div>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="d-flex align-items-center">
                                <div id="machine-status-indicator" class="me-3">
                                    <span class="badge badge-status {{ $machineStatus->isOnline() ? 'bg-success' : 'bg-danger' }}">
                                        <i class="bi bi-circle-fill me-2 {{ $machineStatus->isOnline() ? 'pulse-animation' : '' }}" style="font-size: 8px;"></i>
                                        <span id="machine-status-text">{{ $machineStatus->isOnline() ? 'Online' : 'Offline' }}</span>
                                    </span>
                                </div>
                                <div>
                                    <p class="mb-0 fw-bold">Status Mesin Absensi</p>
                                    <small class="text-muted" id="machine-last-ping">
                                        Terakhir ping: {{ $machineStatus->last_ping ? $machineStatus->last_ping->diffForHumans() : 'Belum pernah' }}
                                    </small>
                                </div>
                            </div>
                            <div class="text-end">
                                <small class="text-muted d-block"><i class="bi bi-hdd-network me-1"></i>IP: {{ $machineStatus->machine_ip ?? '-' }}</small>
                                <small class="text-muted"><i class="bi bi-speedometer2 me-1"></i>Response: <span id="machine-response-time">{{ $machineStatus->response_time ?? 0 }}</span>ms</small>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row g-4 fade-in">
                <div class="col-md-4">
                    <div class="card card-custom p-4 bg-white h-100">
                        <h5 class="fw-bold mb-3"><i class="bi bi-pie-chart me-2 text-success"></i>Grafik Kehadiran Hari Ini</h5>
                        <div class="chart-container d-flex justify-content-center align-items-center" style="min-height: 200px;">
                ...
                <div class="col-md-8">
                    <div class="card card-custom p-4 bg-white h-100">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <h5 class="fw-bold m-0"><i class="bi bi-clock-history me-2 text-success"></i>Absensi Terbaru</h5>
                            ...
                            <table class="table table-hover table-borderless align-middle">
                                ...
                                <tbody>
                                    ...
                                    <tr class="border-bottom">
                                        ...
                                        <td class="small fw-semibold">{{ \Carbon\Carbon::parse($absen->jam_masuk)->format('H:i') }} WIB</td>
                                        <td>
                                            <span class="badge {{ $absen->status == 'Hadir' ? 'bg-success-subtle text-success' : 'bg-warning-subtle text-warning' }} px-3 py-2 small fw-semibold">
                                                {{ $absen->status }}
                                            </span>
                                        </td>
                                    </tr>
            ...
            <div class="row g-4 mt-1 fade-in">
                <div class="col-md-6">
                    <div class="card card-custom p-4 bg-white">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <h5 class="fw-bold m-0"><i class="bi bi-graph-up me-2 text-primary"></i>Tren Kehadiran Mingguan</h5>
                ...
                <div class="col-md-6">
                    <div class="card card-custom p-4 bg-white">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <h5 class="fw-bold m-0"><i class="bi bi-calendar3 me-2 text-primary"></i>Tren Kehadiran Bulanan</h5>
